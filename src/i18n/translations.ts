...
export const translations = {
  ...
  en: {
    ...
    setupStep3Items: ['Select your Chromecast from the list', 'Enter the URL for your screensaver', 'Activate and test!'],
    scriptExplainerTitle: 'What the install script does',
    scriptExplainerItems: [
      'Installs Node.js 18+ if missing',
      'Copies files to',
      'Creates a systemd user service that starts automatically',
      'Sets up auto-updates via git every hour',
      'Scheduled restart at 05:00 for stability',
    ],
