...
export const translations = {
  sv: {
    ...
    // Setup page (new linear Pi guide)
    setupTitle: 'Raspberry Pi – Installationsguide',
    setupSubtitle: 'Chromecast Screensaver via SSH på ~2 minuter',
    sshHelp: 'Behöver du hjälp med SSH?',
    sshEnableTitle: '1. Aktivera SSH',
    sshEnableDesc: 'Kör',
    sshEnableAlt: 'Eller skapa en tom fil',
    sshEnableAltSuffix: 'i boot-partitionen på SD-kortet.',
    sshFindIpTitle: '2. Hitta Pi:ns IP-adress',
    sshFindIpDesc: 'Kör på Pi:n eller kolla i din router:',
    sshConnectTitle: '3. Anslut från din dator',
    sshDefaultPassword: 'Standard-lösenord:',
    sshChangePassword: '(byt med',
    setupStep1: 'Anslut via SSH',
    setupStep2: 'Installera',
    setupStep2Note: 'git och Node.js 18+ installeras automatiskt om de saknas.',
    setupStep3: 'Öppna & konfigurera',
    setupStep3Item1: 'Välj din Chromecast från listan',
    setupStep3Item2: 'Ange URL till din screensaver',
    setupStep3Item3: 'Aktivera och testa!',
    scriptExplainerTitle: 'Vad installationsscriptet gör',
    scriptExplainerNode: 'Installerar Node.js 18+ om det saknas',
    scriptExplainerCopy: 'Kopierar filer till',
    scriptExplainerSystemd: 'Skapar en systemd user service som startar automatiskt',
    scriptExplainerAutoUpdate: 'Sätter upp auto-uppdatering via git varje timme',
    scriptExplainerRestart: 'Schemalagd omstart kl 05:00 för stabilitet',
    troubleshooting: 'Felsökning',
    troubleshootingStatus: 'Kontrollera status:',
    troubleshootingLogs: 'Visa loggar i realtid:',
    troubleshootingRestart: 'Starta om:',
  ...
  en: {
    ...
    // Setup page (new linear Pi guide)
    setupTitle: 'Raspberry Pi – Installation Guide',
    setupSubtitle: 'Chromecast Screensaver via SSH in ~2 minutes',
    sshHelp: 'Need help with SSH?',
    sshEnableTitle: '1. Enable SSH',
    sshEnableDesc: 'Run',
    sshEnableAlt: 'Or create an empty file',
    sshEnableAltSuffix: 'in the boot partition on the SD card.',
    sshFindIpTitle: '2. Find the Pi\'s IP address',
    sshFindIpDesc: 'Run on the Pi or check your router:',
    sshConnectTitle: '3. Connect from your computer',
    sshDefaultPassword: 'Default password:',
    sshChangePassword: '(change with',
    setupStep1: 'Connect via SSH',
    setupStep2: 'Install',
    setupStep2Note: 'git and Node.js 18+ are installed automatically if missing.',
    setupStep3: 'Open & configure',
    setupStep3Item1: 'Select your Chromecast from the list',
    setupStep3Item2: 'Enter the URL for your screensaver',
    setupStep3Item3: 'Activate and test!',
    scriptExplainerTitle: 'What the install script does',
    scriptExplainerNode: 'Installs Node.js 18+ if missing',
    scriptExplainerCopy: 'Copies files to',
    scriptExplainerSystemd: 'Creates a systemd user service that starts automatically',
    scriptExplainerAutoUpdate: 'Sets up auto-updates via git every hour',
    scriptExplainerRestart: 'Scheduled restart at 05:00 for stability',
    troubleshooting: 'Troubleshooting',
    troubleshootingStatus: 'Check status:',
    troubleshootingLogs: 'View logs in real-time:',
    troubleshootingRestart: 'Restart:',
